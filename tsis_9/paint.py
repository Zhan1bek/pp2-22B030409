...
def draw_square(color, pos, side):
    ...
    (pos[0], pos[1]), (pos[0] + side, pos[1]), (pos[0] + side, pos[1] + side), (pos[0], pos[1] + side)), 2)


def draw_right_triangle(color, pos, width, height):
    pygame.draw.polygon(screen, color, ((pos[0], pos[1]), (pos[0] + width, pos[1] + height), (pos[0], pos[1] + height)),
                        3)


def draw_equilateral_triangle(color, pos, side, height):
    pygame.draw.polygon(screen, color, (
    (pos[0], pos[1]), (pos[0] + side // 2, pos[1] + height), (pos[0] - side // 2, pos[1] + height)), 3)


def draw_rhombus(color, pos, width, height):
    pygame.draw.polygon(screen, color, (
    (pos[0], pos[1] + height // 2), (pos[0] + width // 2, pos[1]), (pos[0] + width, pos[1] + height // 2),
    (pos[0] + width // 2, pos[1] + height)), 3)
